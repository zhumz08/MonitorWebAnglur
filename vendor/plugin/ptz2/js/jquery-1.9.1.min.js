...
Date.prototype.toString = function () {
    return this.getFullYear() + "年" + (this.getMonth() + 1) + "月" + this.getDate() + "日 " + buqi(this.getHours()) + ":" + buqi(this.getMinutes());
}

/**
 * 自定义增加监听事件  ie11不在支持attachEvent 方法
 * @param element
 * @param type
 * @param handler
 */
function addEvent(element, type, handler) {
    if (element.attachEvent) {
        if ('WindowProc' == type || 'PTZEvent' == type || 'PlayBackAction' == type) {
