      ...
      function ($stateProvider,   $urlRouterProvider) {
          ...
          $stateProvider
              ...
              .state('monitorweb', {
                  abstract: true,
                  url: '/monitorweb',
                  templateUrl: 'view/realtime/layout.html'
              })
              .state('monitorweb.video', {
                  url: '/video',
                  views: {
                      '': {
                          templateUrl: 'view/realtime/main_content.html'
                      },
                      'footer':{
                          templateUrl: 'view/realtime/footer.html'
                      }
                  },
                  resolve: {
                      deps: ['uiLoad','$ocLazyLoad',
                          function( uiLoad,$ocLazyLoad){
                              $ocLazyLoad.load('angularBootstrapNavTree').then(
                                  function(){
                                      return $ocLazyLoad.load('js/controllers/tree.js');
                                  }
                              );

                              $ocLazyLoad.load('vr.directives.slider').then(
                                  function(){
                                      return $ocLazyLoad.load('js/controllers/slider.js');
                                  }
                              );
